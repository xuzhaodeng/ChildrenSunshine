...
public class AuditController extends BaseController {
    ...
    /*
    @ApiOperation(value = "审核操作", notes = "对儿童登记表进行审核操作")
    @RequestMapping(value = "auditOld", method = RequestMethod.POST)
    public Result auditOld(@RequestBody AuditRequest auditRequest) {
        logger.debug(auditRequest.toString());
        Date now = new Date();
